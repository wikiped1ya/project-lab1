...
// TODO: сделать еще одного наследника, который будет производить
//       буферизированный ввод-вывод, размер буфера передается при
//       создании
//
// TODO: из RLE2 убрать лишние буферы, оставить только то, что необходимо
